/** =========================================================================
 * @file CampbellClariVUE10_ZebraTechHydroWiper.ino
 * @brief Logging data from ClariVUE™10 turbidity sensor
 *        and publishing to Monitor My Watershed. Periodic
 *        cleaning wipes from ZebraTech Hydro-Wiper prior
 *        to data measurements.
 *
 * @author Adolfo Lopez Miranda <https://biggslab.sdsu.edu/>
 *
